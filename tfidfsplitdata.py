...
#SPlit the data might not be used in final implementation
...
X_train, X_test, y_train, y_test = train_test_split(results, results[1], test_size=0.2)

#Text of train articles 
article_contents = [i[0] for i in X_train]
#label of train articles
article_labels = [type_mapping(i[1]) for i in y_train]
...
print(f"prediction :  {article_clf.predict([X_test[0]])}")
print(f"True value : {type_mapping(y_test[0])}")
